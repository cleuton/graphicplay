 ...
 * 
 */
package com.obomprogramador.games.impulseForce;
 ...
 *
 */
public class ImpulseTorque extends JFrame {
	...
	protected String tituloParado = "Impulso e torque Box2D - Clique para rodar simulação";
	protected String tituloRodando = "(Rodando) Impulso e torque Box2D - Clique para parar simulação";
	...
	protected Body chao;
	protected Body quadrado1;
	protected Body quadrado2;
	protected Body quadrado3;
	protected Body quadrado4;
	...
	public static void main (String [] args) {
		ImpulseTorque lm = new ImpulseTorque();
		lm.setVisible(true);
	...
	private void initBox2D() {
		...
		quadradoDef.position.set(larguraMundo / 5, 9);
		quadrado1 = world.createBody(quadradoDef);
		quadrado1.setType(BodyType.DYNAMIC);
		...
		quadrado1.createFixture(quadradoFixDef);
		quadrado1.resetMassData();
		quadrado1.setUserData(quadradoTamanho);
		
		// Criamos o segundo quadrado dinamico
		BodyDef quadradoDef2 = new BodyDef();
		quadradoDef2.position.set((larguraMundo / 5) * 2, 9);
		quadrado2 = world.createBody(quadradoDef2);
		quadrado2.setType(BodyType.DYNAMIC);
		Vec2 quadradoTamanho2 = new Vec2(10.0f, 10.0f);
		PolygonShape quadradoShape2 = new PolygonShape();
		quadradoShape2.setAsBox(5.0f, 5.0f);
		FixtureDef quadradoFixDef2 = new FixtureDef();
		quadradoFixDef2.shape = quadradoShape2;
		quadradoFixDef2.density = 2.0f;
		quadradoFixDef2.restitution = 0.3f;
		quadradoFixDef2.friction = 0.2f;
		quadrado2.createFixture(quadradoFixDef2);
		quadrado2.resetMassData();
		quadrado2.setUserData(quadradoTamanho2);

		// Criamos o terceiro quadrado dinamico
		BodyDef quadradoDef3 = new BodyDef();
		quadradoDef3.position.set((larguraMundo / 5) * 3, 9);
		quadrado3 = world.createBody(quadradoDef3);
		quadrado3.setType(BodyType.DYNAMIC);
		Vec2 quadradoTamanho3 = new Vec2(10.0f, 10.0f);
		PolygonShape quadradoShape3 = new PolygonShape();
		quadradoShape3.setAsBox(5.0f, 5.0f);
		FixtureDef quadradoFixDef3 = new FixtureDef();
		quadradoFixDef3.shape = quadradoShape3;
		quadradoFixDef3.density = 2.0f;
		quadradoFixDef3.restitution = 0.3f;
		quadradoFixDef3.friction = 0.2f;
		quadrado3.createFixture(quadradoFixDef3);
		quadrado3.resetMassData();
		quadrado3.setUserData(quadradoTamanho3);
		
		// Criamos o quarto quadrado dinamico
		BodyDef quadradoDef4 = new BodyDef();
		quadradoDef4.position.set((larguraMundo / 5) * 4, 9);
		quadrado4 = world.createBody(quadradoDef4);
		quadrado4.setType(BodyType.DYNAMIC);
		Vec2 quadradoTamanho4 = new Vec2(10.0f, 10.0f);
		PolygonShape quadradoShape4 = new PolygonShape();
		quadradoShape4.setAsBox(5.0f, 5.0f);
		FixtureDef quadradoFixDef4 = new FixtureDef();
		quadradoFixDef4.shape = quadradoShape4;
		quadradoFixDef4.density = 2.0f;
		quadradoFixDef4.restitution = 0.3f;
		quadradoFixDef4.friction = 0.2f;
		quadrado4.createFixture(quadradoFixDef4);
		quadrado4.resetMassData();
		quadrado4.setUserData(quadradoTamanho4);
	}
	...
	private void redesenhar() {
		...
		synchronized(gImagem) {
			...
			gx.drawPolygon(criarPoligono(quadrado1));
			
			gx.setColor(Color.green);
			gx.drawPolygon(criarPoligono(quadrado2));
	
			gx.setColor(Color.cyan);
			gx.drawPolygon(criarPoligono(quadrado3));
			
			gx.setColor(Color.magenta);
			gx.drawPolygon(criarPoligono(quadrado4));
	...
	class TrataTeclado implements KeyListener {
		...
		public void keyPressed(KeyEvent key) {
			if (key.getKeyCode() == KeyEvent.VK_SPACE) {
				...
				/* primeiro levantamos o quadrado e depois aplicamos o torque */
				...
				/* primeiro levantamos o quadrado e depois aplicamos o impulso */
