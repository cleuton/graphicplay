 ...
 *
 */
public class ForceMain extends JFrame {
	...
	protected String tituloParado = "Force Box2D - Clique para rodar simulação";
	protected String tituloRodando = "(Rodando) Force Box2D - Clique para parar simulação";
	...
	class TrataTeclado implements KeyListener {
		...
		public void keyPressed(KeyEvent key) {
			if (key.getKeyCode() == KeyEvent.VK_SPACE) {
				Vec2 forca = new Vec2(+300.0f * bola.getMass(), +300.0f * bola.getMass());
				bola.setAwake(true);
				bola.applyForce(forca, bola.getWorldCenter());
