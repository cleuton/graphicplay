 ...
 * 
 */
package com.obomprogramador.games.rotatebox2d;
 ...
 *
 */
public class RotationBox2D extends JFrame {
	...
	protected String tituloParado = "Rotação Box2D - Clique para rodar simulação";
	protected String tituloRodando = "(Rodando) Rotação Box2D - Clique para parar simulação";
	...
	public static void main (String [] args) {
		RotationBox2D lm = new RotationBox2D();
		lm.setVisible(true);
	...
	private void redesenhar() {
		...
		synchronized(gImagem) {
			...
			gx.drawString("Aceleracao X: " + 300 + " m/s",30, 24);
			gx.drawString("Forca: " + quadrado.getMass() * 300.0f + " N", 30, 36);
			gx.drawString("Distancia X: " + 
					(quadrado.getTransform().position.x 
							- origemX) + " m", 30, 48);
